...
from .config_so101_follower_double import SO101FollowerDoubleConfig

logger = logging.getLogger(__name__)


class SO101FollowerDouble(Robot):
    """
    SO-101 Follower Arm designed by TheRobotStudio and Hugging Face.
    """

    config_class = SO101FollowerDoubleConfig
    name = "so101_follower_double"

    def __init__(self, config: SO101FollowerDoubleConfig):
